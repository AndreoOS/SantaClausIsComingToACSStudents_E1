...
public final class OutputDatabase {
    ...
    private static OutputDatabase outputDatabase = null;
     ...
     */
    public static OutputDatabase getInstance() {
    ...
    public static OutputDatabase getOutputDatabase() {
        return outputDatabase;
    }

    public static void setOutputDatabase(final OutputDatabase outputDatabase) {
        OutputDatabase.outputDatabase = outputDatabase;
    }
}
